    ...
    <div className='relative flex justify-center md:flex-col min-h-screen'>
      ...
      <div className='flex-1 justify-start sm:px-4 p-12 sm:pb-4'>
        <div className='flex flex-row sm:flex-col'>
          <h2 className='font-poppins font-semibold dark:text-white text-nft-black-1 text-2xl minlg:text-3xl'>
            {nft.name}
          </h2>
        </div>
        ...
        <div className='mt-10 flex flex-col '>
          ...
          <div className='mt-3'>
            <p className='font-poppins dark:text-white text-nft-black-1 text-base minlg:text-base font-normal'>
              {nft.description}
            </p>
          </div>
        </div>
        ...
        <Modal
          ...
          footer={
            <div className='flex flex-row sm:flex-col sm:w-full'>
              <Button
                btnName='Checkout'
                classStyles={'mr-5 sm:mr-0 rounded'}
                handleClick={checkout}
              />
              <Button
                btnName='Cancel'
                classStyles={'sm:w-full sm:mt-2 rounded'}
                handleClick={() => {
                  setPaymentModal(false)
                }}
              />
        ...
        <Modal
          ...
          body={
            ...
            >
              ...
              <p className='font-poppins dark:text-white text-nft-black-1 font-normal text-md minlg:text-xl mt-10'>
          ...
          footer={
            <div className='flexCenter flex-col'>
              <Button
                ...
                classStyles={'sm:mb-5 sm:mr-0 rounded'}
                handleClick={() => {
                  router.push('/my-nfts')
                }}
              />
